...
pub struct LotteryGame {
    ...
    pub total_available_funds: u32, // total available funds equal to the lottery game owned by participants
    ...
    pub unit_cost_of_lottery_game: u32, // unit cost of lottery_game
